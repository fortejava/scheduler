...
class AutocompleteCustomer {
    ...
    init() {
        ...
        console.log('AutocompleteCustomer initialized:', this.config.inputId);
    }
    ...
    setCustomers(customers) {
        ...
        console.log(`AutocompleteCustomer: Loaded ${customers.length} customers`);
    }
    ...
    destroy() {
        ...
        console.log('AutocompleteCustomer destroyed:', this.config.inputId);
    }
