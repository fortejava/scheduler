<%@ WebHandler Language="C#" Class="GetInvoiceByMonth" %>
...
public class GetInvoiceByMonth : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) 
    {
        ...
        {
            List<Invoice> invoicesFound = InvoicesService.GetInvoicesByMonth(month, year);
